...
import { MessageCircle, Mail, MapPin, ArrowLeft, Heart, Share2 } from 'lucide-react';
                        ...
                        <div className="mt-auto bg-gray-50 p-6 rounded-xl border border-gray-100">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <button
                                    onClick={() => {
                                        if (!user) {
                                            ...
                                            alert('Chat feature coming soon!'); // Or integration with Messages
                                        }
                                    }}
                                    className="flex items-center justify-center w-full py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium transition"
                                >
                                ...
                                <button
                                    onClick={() => {
                                        if (!user) {
                                            alert('Please login to view seller email');
                                            navigate('/login', { state: { from: `/items/${id}` } });
                                        } else {
                                            window.location.href = `mailto:${item.seller_email}`;
                                        }
                                    }}
                                    className="flex items-center justify-center w-full py-3 bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 rounded-lg font-medium transition"
                                >
